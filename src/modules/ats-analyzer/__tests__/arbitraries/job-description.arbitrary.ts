...
const categorizedKeywordArbitrary = (
	...
	fc.record({
		...
		frequency: fc.integer({ max: 5, min: 1 }),
 ...
 */
export const jobKeywordsArbitrary: fc.Arbitrary<CategorizedKeyword[]> = fc
	.tuple(
		fc.array(hardSkillKeywordArbitrary, { maxLength: 10, minLength: 1 }),
		fc.array(softSkillKeywordArbitrary, { maxLength: 5, minLength: 0 }),
		fc.array(generalKeywordArbitrary, { maxLength: 5, minLength: 0 }),
	)
 ...
 */
export const nonEmptyJobKeywordsArbitrary: fc.Arbitrary<CategorizedKeyword[]> = fc
	.tuple(
		fc.array(hardSkillKeywordArbitrary, { maxLength: 10, minLength: 1 }),
 ...
 */
export const jobDescriptionTextArbitrary: fc.Arbitrary<string> = fc
	.tuple(
		fc.constantFrom(
			'Software Engineer',
			'Frontend Developer',
		...
		fc.array(fc.constantFrom(...HARD_SKILLS), { maxLength: 8, minLength: 3 }),
		fc.array(fc.constantFrom(...SOFT_SKILLS), { maxLength: 3, minLength: 1 }),
