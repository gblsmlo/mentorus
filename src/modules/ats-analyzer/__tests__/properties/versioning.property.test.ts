...
function restoreVersion(
  ...
  if (!sourceVersion) {
    return { restoredContent: null, newVersion: null }
  }
  ...
  return { restoredContent, newVersion }
}
...
describe('Version Number Properties', () => {
  ...
  it('Property 6: Sequential saves produce monotonically increasing version numbers', () => {
    ...
    fc.assert(
      fc.property(
        fc.array(resumeContentArbitrary, { minLength: 1, maxLength: 10 }),
        (contents) => {
...
describe('Version Restoration Properties', () => {
  it('Property 7: Restored content is deeply equal to source version content', () => {
    ...
    fc.assert(
      fc.property(
        fc.array(resumeContentArbitrary, { minLength: 1, maxLength: 5 }),
